...
4. With handoff JSON present, `python main.py view-handoff` — expect a local server on port 8765 and the browser page listing open questions / consistency issues (Ctrl+C to stop).
